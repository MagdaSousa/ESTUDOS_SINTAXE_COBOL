       ...
       DATA DIVISION.
           ...
           01 WS-NUM4 PIC 9(6).
           01 WS-ADDRESS.
               05 WS-HOUSE-NUMBER PIC 9(3). *> NIVEL INFERIOR , DIZENDO QUE ELAS PERTENCEM A VARIÁVEL ADRESS DE NÍVEL 01
       ...
       PROCEDURE DIVISION.
           ...
           MOVE WS-NUM1 TO WS-NUM2 WS-NUM3. *> MOVE, FAZ A ATRIBUIÇÃO DE UM VALOR PARA UMA VARIÁVEL QUALQUER
